<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="EditXml.ascx.cs" Inherits="DotNetNuke.Modules.Xml.EditXml" %>
    ...
    <tr>
        <td>
            <dnn:SectionHead ID="dshXmlSource" runat="server" IsExpanded="true" IncludeRule="true"
                ResourceKey="dshXmlSource" Section="secXmlSource" CssClass="Head"></dnn:SectionHead>
        </td>
    </tr>
    <tr id="secXmlSource" runat="server">
        <td>
            ...
            <div class="normalbold">
                <asp:Label ID="lblXmlSourceType" resourcekey="lblXmlSourceType" runat="server"> Data Source Typ:</asp:Label></div>
    ...
    <tr>
        <td>
            ...
            <dnn:SectionHead ID="dshXslTrans" runat="server" IsExpanded="true" IncludeRule="true"
                ResourceKey="dshXslTrans" Section="secXslTrans" CssClass="Head"></dnn:SectionHead>
        </td>
    </tr>
    <tr id="secXslTrans" runat="server">
        <td>
            <div class="normalbold">
                <asp:Label ID="Label1" resourcekey="lblXmlRenderingType" runat="server"> Data Source Typ:</asp:Label></div>
    ...
    <tr>
        <td>
            ...
            <dnn:SectionHead ID="dshAdvanced" runat="server" IsExpanded="false" IncludeRule="true"
                ResourceKey="dshAdvancedTitle" Section="secAdvanced" CssClass="Head"></dnn:SectionHead>
        </td>
    </tr>
